...
export const products = sqliteTable(
  "products",
  {
    ...
    unitOfMeasurement: text("unit_of_measurement").notNull().default("м2"), // Standardized unit IDs defined in ~/data/units.ts
    isActive: integer("is_active", { mode: "boolean" }).notNull().default(true),
    isFeatured: integer("is_featured", { mode: "boolean" })
      .notNull()
      .default(false),
    discountedPrice: real("discounted_price"), // The actual sale price entered by admin (source of truth for discounts)
...
export const variationAttributes = sqliteTable(
  "variation_attributes",
  {
    ...
    attributeId: text("attributeId").notNull(), // TEXT - original schema
